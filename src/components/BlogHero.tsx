  ...
  return (
    <div className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[calc(100vh-140px)] overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1551763337-e05b91996d32?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaXRuZXNzJTIwYmxvZyUyMHdyaXRpbmd8ZW58MXx8fHwxNzY2NDM0NTQ2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral)',
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-white px-4 sm:px-6 md:px-8 z-10">
        ...
        >
          Insights and inspiration for a healthier lifestyle
        </motion.p>
      </div>
